...
public class ScheduledThreadPoolExectuorWithDynamicSizeDiffblueTest {
  /**
   * Test {@link
   * ScheduledThreadPoolExectuorWithDynamicSize#ScheduledThreadPoolExectuorWithDynamicSize(DynamicIntProperty,
   * ThreadFactory)}.
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ScheduledThreadPoolExectuorWithDynamicSize.<init>(DynamicIntProperty, ThreadFactory)"
  })
  public void testNewScheduledThreadPoolExectuorWithDynamicSize() {
    ...
    assertFalse(
        actualScheduledThreadPoolExectuorWithDynamicSize
    ...
    assertEquals(
        Integer.MAX_VALUE, actualScheduledThreadPoolExectuorWithDynamicSize.getMaximumPoolSize());

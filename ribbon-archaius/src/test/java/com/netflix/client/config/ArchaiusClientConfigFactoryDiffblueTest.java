...
public class ArchaiusClientConfigFactoryDiffblueTest {
   ...
   * {@link ArchaiusClientConfigFactory}
   */
  @Test
  ...
  public void testNewConfig() {
    ...
    // Assert
    PropertyResolver propertyResolver = ((DefaultClientConfigImpl) actualNewConfigResult).getPropertyResolver();
    assertTrue(propertyResolver instanceof ArchaiusPropertyResolver);
    ...
    assertEquals(0, ((ArchaiusPropertyResolver) propertyResolver).getActionCount());

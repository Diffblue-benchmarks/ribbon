...
public class DefaultClientConfigImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "String DefaultClientConfigImpl.getDefaultClientClassname()",
    ...
    "int DefaultClientConfigImpl.getDefaultPoolMinThreads()",
    "int DefaultClientConfigImpl.getDefaultPort()",
  ...
  public void testGettersAndSetters() {
    ...
    int actualDefaultConnectionIdleTimertaskRepeatInMsecs =
        emptyConfig.getDefaultConnectionIdleTimertaskRepeatInMsecs();
    int actualDefaultConnectionManagerTimeout = emptyConfig.getDefaultConnectionManagerTimeout();
    Boolean actualDefaultConnectionPoolCleanerTaskEnabled =
        emptyConfig.getDefaultConnectionPoolCleanerTaskEnabled();
    ...
    Boolean actualDefaultEnableGzipContentEncodingFilter =
        emptyConfig.getDefaultEnableGzipContentEncodingFilter();
    ...
    int actualDefaultMaxRequestsAllowedPerWindow =
        emptyConfig.getDefaultMaxRequestsAllowedPerWindow();
    int actualDefaultMaxRetriesPerServerPrimeConnection =
        emptyConfig.getDefaultMaxRetriesPerServerPrimeConnection();
    ...
    int actualDefaultMaxTotalTimeToPrimeConnections =
        emptyConfig.getDefaultMaxTotalTimeToPrimeConnections();
    ...
    String actualDefaultNfloadbalancerPingClassname =
        emptyConfig.getDefaultNfloadbalancerPingClassname();
    String actualDefaultNfloadbalancerRuleClassname =
        emptyConfig.getDefaultNfloadbalancerRuleClassname();
    Boolean actualDefaultOkToRetryOnAllOperations =
        emptyConfig.getDefaultOkToRetryOnAllOperations();
    float actualDefaultPercentageNiwsEventLogged =
        emptyConfig.getDefaultPercentageNiwsEventLogged();
    ...
    Boolean actualDefaultPrioritizeVipAddressBasedServers =
        emptyConfig.getDefaultPrioritizeVipAddressBasedServers();
    int actualDefaultReadTimeout = emptyConfig.getDefaultReadTimeout();
    int actualDefaultRequestThrottlingWindowInMillis =
        emptyConfig.getDefaultRequestThrottlingWindowInMillis();
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_CLIENT_CLASSNAME, actualDefaultClientClassname);
    assertEquals(
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_CONNECTION_MANAGER_TIMEOUT,
        actualDefaultConnectTimeout);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_CONNECTION_MANAGER_TIMEOUT,
        actualDefaultConnectionManagerTimeout);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_CONNECTIONS_PER_HOST,
        actualDefaultMaxConnectionsPerHost);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_CONNECTIONS_PER_HOST,
        actualDefaultMaxHttpConnectionsPerHost);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_REQUESTS_ALLOWED_PER_WINDOW,
        actualDefaultMaxRequestsAllowedPerWindow);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_RETRIES_PER_SERVER_PRIME_CONNECTION,
        actualDefaultMaxRetriesPerServerPrimeConnection);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_TOTAL_CONNECTIONS,
        actualDefaultMaxTotalConnections);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_TOTAL_CONNECTIONS,
        actualDefaultMaxTotalHttpConnections);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MAX_TOTAL_CONNECTIONS, actualDefaultPoolMaxThreads);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MIN_PRIME_CONNECTIONS_RATIO,
        actualDefaultMinPrimeConnectionsRatio,
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_CLASSNAME,
        actualDefaultNfloadbalancerClassname);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_PING_CLASSNAME,
        actualDefaultNfloadbalancerPingClassname);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_RULE_CLASSNAME,
        actualDefaultNfloadbalancerRuleClassname);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PERCENTAGE_NIWS_EVENT_LOGGED,
        actualDefaultPercentageNiwsEventLogged,
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME,
        actualDefaultPoolKeepAliveTime);
    assertEquals(AbstractDefaultClientConfigImpl.DEFAULT_PORT, actualDefaultPort);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PRIME_CONNECTIONS_CLASS,
        actualDefaultPrimeConnectionsClass);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PRIME_CONNECTIONS_URI,
        actualDefaultPrimeConnectionsUri);
    assertEquals(AbstractDefaultClientConfigImpl.DEFAULT_READ_TIMEOUT, actualDefaultReadTimeout);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_REQUEST_THROTTLING_WINDOW_IN_MILLIS,
        actualDefaultRequestThrottlingWindowInMillis);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_SEVER_LIST_CLASS, actualDefaultSeverListClass);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_VIPADDRESS_RESOLVER_CLASSNAME,
   ...
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#DefaultClientConfigImpl()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewDefaultClientConfigImpl() {
    ...
    assertEquals(
        TimeUnit.SECONDS, actualDefaultClientConfigImpl.getDefaultPoolKeepAliveTimeUnits());
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MIN_PRIME_CONNECTIONS_RATIO,
        actualDefaultClientConfigImpl.getDefaultMinPrimeConnectionsRatio(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_CLASSNAME,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PERCENTAGE_NIWS_EVENT_LOGGED,
        actualDefaultClientConfigImpl.getDefaultPercentageNiwsEventLogged(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME,
        actualDefaultClientConfigImpl.getDefaultPoolKeepAliveTime());
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PORT,
        actualDefaultClientConfigImpl.getDefaultPort());
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PRIME_CONNECTIONS_CLASS,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_READ_TIMEOUT,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_SEVER_LIST_CLASS,
    ...
    assertEquals(
        ...
        actualDefaultClientConfigImpl.getNameSpace());
  }

  /**
   * Test {@link DefaultClientConfigImpl#DefaultClientConfigImpl(String)}.
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#DefaultClientConfigImpl(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewDefaultClientConfigImpl2() {
    ...
    DefaultClientConfigImpl actualDefaultClientConfigImpl =
        new DefaultClientConfigImpl("\"myClient.ribbon.MaxAutoRetries\"");
   ...
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#loadDefaultValues()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#getDefaultPropName(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testGetEmptyConfig() {
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MIN_PRIME_CONNECTIONS_RATIO,
        actualEmptyConfig.getDefaultMinPrimeConnectionsRatio(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_CLASSNAME,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PERCENTAGE_NIWS_EVENT_LOGGED,
        actualEmptyConfig.getDefaultPercentageNiwsEventLogged(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_READ_TIMEOUT,
        actualEmptyConfig.getDefaultReadTimeout());
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_REQUEST_THROTTLING_WINDOW_IN_MILLIS,
    ...
    assertEquals(
        DefaultClientConfigImpl.DEFAULT_PROPERTY_NAME_SPACE, actualEmptyConfig.getNameSpace());
  }

  /**
   * Test {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues()}.
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DefaultClientConfigImpl DefaultClientConfigImpl.getClientConfigWithDefaultValues()"
  })
  public void testGetClientConfigWithDefaultValues() {
    ...
    assertEquals(39, properties.size());
    assertEquals(
        TimeUnit.SECONDS, actualClientConfigWithDefaultValues.getDefaultPoolKeepAliveTimeUnits());
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_MIN_PRIME_CONNECTIONS_RATIO,
        actualClientConfigWithDefaultValues.getDefaultMinPrimeConnectionsRatio(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_NFLOADBALANCER_CLASSNAME,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PERCENTAGE_NIWS_EVENT_LOGGED,
        actualClientConfigWithDefaultValues.getDefaultPercentageNiwsEventLogged(),
        0.0f);
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME,
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PORT,
        actualClientConfigWithDefaultValues.getDefaultPort());
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_PRIME_CONNECTIONS_CLASS,
  ...
  /**
   * Test {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues(String)} with {@code
   * clientName}.
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "DefaultClientConfigImpl DefaultClientConfigImpl.getClientConfigWithDefaultValues(String)"
  })
  ...
  /**
   * Test {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues(String, String)} with
   * {@code clientName}, {@code nameSpace}.
   *
   * <p>Method under test: {@link DefaultClientConfigImpl#getClientConfigWithDefaultValues(String,
   * String)}
   */

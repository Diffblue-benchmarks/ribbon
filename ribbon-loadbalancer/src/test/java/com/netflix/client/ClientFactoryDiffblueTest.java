...
public class ClientFactoryDiffblueTest {
   ...
   * configClass}.
   *
   * <p>Method under test: {@link ClientFactory#getNamedLoadBalancer(String, Class)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"ILoadBalancer ClientFactory.getNamedLoadBalancer(String, Class)"})
  public void testGetNamedLoadBalancerWithNameConfigClass() {
    // Arrange
    ...
    assertTrue(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getClientConfig()
            instanceof DefaultClientConfigImpl);
    assertTrue(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getRule()
            instanceof AvailabilityFilteringRule);
    assertTrue(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getServerListImpl()
            instanceof ConfigurationBasedServerList);
    assertTrue(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getPing() instanceof DummyPing);
    assertTrue(
    ...
    assertTrue(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getFilter()
            instanceof ZoneAffinityServerListFilter);
    ...
    assertEquals(
        2, ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).getMaxTotalPingTime());
    ...
    assertFalse(
        ((ZoneAwareLoadBalancer<Server>) actualNamedLoadBalancer).isEnablePrimingConnections());
   ...
   * <ul>
   *   <li>When {@code Name}.
   *   <li>Then return ClientConfig ClientName is {@code Name}.
   * </ul>
   *
   * <p>Method under test: {@link ClientFactory#getNamedLoadBalancer(String)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ILoadBalancer ClientFactory.getNamedLoadBalancer(String)"})
  public void testGetNamedLoadBalancerWithName_whenName_thenReturnClientConfigClientNameIsName() {
    // Arrange and Act

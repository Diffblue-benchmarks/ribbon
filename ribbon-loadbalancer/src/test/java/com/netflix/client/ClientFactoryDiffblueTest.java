...
public class ClientFactoryDiffblueTest {
  ...
  public void testGetNamedLoadBalancerWithName() {
    ...
    ILoadBalancer actualNamedLoadBalancer =
        ClientFactory.getNamedLoadBalancer("\"DefaultLoadBalancer\"");
    ...
    assertEquals("\"DefaultLoadBalancer\"", clientConfig.getClientName());
    assertEquals(
        "\"DefaultLoadBalancer\"",
    ...
    assertEquals("\"DefaultLoadBalancer\"", loadBalancerStats.getName());
    assertSame(

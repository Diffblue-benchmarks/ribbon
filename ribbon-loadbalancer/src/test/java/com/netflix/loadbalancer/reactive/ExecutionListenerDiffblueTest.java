...
public class ExecutionListenerDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link AbortExecutionException#AbortExecutionException(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AbortExecutionException.<init>(String)",
  ...
  public void testAbortExecutionExceptionNewAbortExecutionException_thenReturnCauseIsNull() {
    // Arrange and Act
    AbortExecutionException actualAbortExecutionException =
        new AbortExecutionException("An error occurred");
  ...
  public void testAbortExecutionExceptionNewAbortExecutionException_thenReturnCauseIsThrowable() {
    ...
    // Act
    AbortExecutionException actualAbortExecutionException =
        new AbortExecutionException("An error occurred", cause);

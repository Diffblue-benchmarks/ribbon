...
public class ServerListSubsetFilterDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ServerListSubsetFilter#getFilteredListOfServers(List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  /**
   * Test {@link ServerListSubsetFilter#compare(Server, Server)} with {@code Server}, {@code Server}.
   * <p>
   ...
   * Test {@link ServerListSubsetFilter#compare(Server, Server)} with {@code Server}, {@code Server}.
   * <ul>
   *   <li>Given {@link ServerStats#ServerStats()} incrementActiveRequestsCount.</li>
   * </ul>
   * <p>
   * Method under test: {@link ServerListSubsetFilter#compare(Server, Server)}
   */

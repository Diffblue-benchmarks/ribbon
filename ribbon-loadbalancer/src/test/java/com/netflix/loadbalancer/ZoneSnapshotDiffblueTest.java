...
public class ZoneSnapshotDiffblueTest {
  ...
  @MethodsUnderTest({"void ZoneSnapshot.<init>()", "void ZoneSnapshot.<init>(int, int, int, double)",
      "int ZoneSnapshot.getActiveRequestsCount()", "int ZoneSnapshot.getCircuitTrippedCount()",
      "int ZoneSnapshot.getInstanceCount()", "double ZoneSnapshot.getLoadPerServer()",

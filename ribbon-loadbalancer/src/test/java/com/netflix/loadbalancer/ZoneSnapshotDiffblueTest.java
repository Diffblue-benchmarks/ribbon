...
public class ZoneSnapshotDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ZoneSnapshot.<init>()",
    "void ZoneSnapshot.<init>(int, int, int, double)",
    "int ZoneSnapshot.getActiveRequestsCount()",
    "int ZoneSnapshot.getCircuitTrippedCount()",
    "int ZoneSnapshot.getInstanceCount()",
    "double ZoneSnapshot.getLoadPerServer()",
    "String ZoneSnapshot.toString()"
  })
  public void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        "ZoneSnapshot [instanceCount=0, loadPerServer=0.0, circuitTrippedCount=0, activeRequestsCount=0]",
  ...
  public void testGettersAndSetters2() {
    ...
    // Assert
    assertEquals(
        "ZoneSnapshot [instanceCount=3, loadPerServer=10.0, circuitTrippedCount=3, activeRequestsCount=3]",
        actualToStringResult);

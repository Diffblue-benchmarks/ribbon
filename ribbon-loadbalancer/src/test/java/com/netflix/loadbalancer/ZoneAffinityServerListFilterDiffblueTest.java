...
public class ZoneAffinityServerListFilterDiffblueTest {
  ...
  @MethodsUnderTest({"void ZoneAffinityServerListFilter.<init>()",
   ...
   * <ul>
   *   <li>Given {@link ServerListSubsetFilter#ServerListSubsetFilter()}.</li>
   *   <li>When {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ZoneAffinityServerListFilter#getFilteredListOfServers(List)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * Test {@link ZoneAffinityServerListFilter#getFilteredListOfServers(List)}.
   * <ul>
   *   <li>Given {@link ZoneAffinityServerListFilter#ZoneAffinityServerListFilter()}.</li>
   *   <li>When {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ZoneAffinityServerListFilter#getFilteredListOfServers(List)}

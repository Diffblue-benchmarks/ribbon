...
public class NoOpLoadBalancerDiffblueTest {
   ...
   * <p>
   * Method under test: {@link NoOpLoadBalancer#getServerList(boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link NoOpLoadBalancer#getServerList(ServerGroup)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoOpLoadBalancer.<init>()", "List NoOpLoadBalancer.getAllServers()",
      "LoadBalancerStats NoOpLoadBalancer.getLoadBalancerStats()", "List NoOpLoadBalancer.getReachableServers()"})

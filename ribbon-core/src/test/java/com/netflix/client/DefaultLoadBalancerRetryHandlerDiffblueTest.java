...
public class DefaultLoadBalancerRetryHandlerDiffblueTest {
  ...
  /**
   * Test {@link DefaultLoadBalancerRetryHandler#isRetriableException(Throwable, boolean)}.
   * <ul>
   *   <li>Given {@link DefaultLoadBalancerRetryHandler#DefaultLoadBalancerRetryHandler()}.</li>
   *   <li>Then return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DefaultLoadBalancerRetryHandler#isRetriableException(Throwable, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean DefaultLoadBalancerRetryHandler.isRetriableException(Throwable, boolean)"})
  public void testIsRetriableException_givenDefaultLoadBalancerRetryHandler_thenReturnFalse() {
    // Arrange
  ...
  /**
   * Test {@link DefaultLoadBalancerRetryHandler#isCircuitTrippingException(Throwable)}.
   * <p>
   * Method under test: {@link DefaultLoadBalancerRetryHandler#isCircuitTrippingException(Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean DefaultLoadBalancerRetryHandler.isCircuitTrippingException(Throwable)"})

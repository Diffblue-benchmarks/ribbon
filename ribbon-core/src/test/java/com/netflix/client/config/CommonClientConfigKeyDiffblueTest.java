...
public class CommonClientConfigKeyDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CommonClientConfigKey#values()}
   */
  @Test
  ...
  public void testValues() {
    ...
    assertEquals(
        "SECONDS",
        actualValuesResult[AbstractDefaultClientConfigImpl.DEFAULT_MAX_CONNECTIONS_PER_HOST]
            .defaultValue());
    ...
    assertEquals(
        ...
        ((Float) actualValuesResult[12].defaultValue()).floatValue(),
        0.0f);
    assertEquals(
    ...
    assertEquals(
        AbstractDefaultClientConfigImpl.DEFAULT_SERVER_LIST_UPDATER_CLASS,
   ...
   *
   * <p>Method under test: {@link CommonClientConfigKey#keys()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Then return defaultValue intValue is {@link
   *       AbstractDefaultClientConfigImpl#DEFAULT_CONNECTION_MANAGER_TIMEOUT}.
   * </ul>
   *
   * <p>Method under test: {@link CommonClientConfigKey#valueOf(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue

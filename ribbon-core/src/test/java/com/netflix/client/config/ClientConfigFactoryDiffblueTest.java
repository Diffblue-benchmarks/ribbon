...
public class ClientConfigFactoryDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ClientConfigFactory#findDefaultConfigFactory()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testFindDefaultConfigFactory() {
    // Arrange and Act
    ClientConfigFactory actualFindDefaultConfigFactoryResult = ClientConfigFactory.findDefaultConfigFactory();
    ...
    assertTrue(
        ((DefaultClientConfigImpl) actualNewConfigResult).getPropertyResolver() instanceof ArchaiusPropertyResolver);

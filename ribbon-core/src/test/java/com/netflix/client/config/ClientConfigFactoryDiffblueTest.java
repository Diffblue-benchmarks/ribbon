...
public class ClientConfigFactoryDiffblueTest {
  /**
   * Test {@link ClientConfigFactory#getPriority()}.
   *
   * <p>Method under test: {@link ClientConfigFactory#getPriority()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"int ClientConfigFactory.getPriority()"})
  ...
  /**
   * Test {@link ClientConfigFactory#findDefaultConfigFactory()}.
   *
   * <p>Method under test: {@link ClientConfigFactory#findDefaultConfigFactory()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"ClientConfigFactory ClientConfigFactory.findDefaultConfigFactory()"})
  public void testFindDefaultConfigFactory() {
    // Arrange and Act
    ClientConfigFactory actualFindDefaultConfigFactoryResult =
        ClientConfigFactory.findDefaultConfigFactory();
    IClientConfig actualNewConfigResult = actualFindDefaultConfigFactoryResult.newConfig();

    // Assert
    assertTrue(actualFindDefaultConfigFactoryResult instanceof ArchaiusClientConfigFactory);
    assertTrue(
    ...
    assertEquals(0, actualFindDefaultConfigFactoryResult.getPriority());
    ...
    assertEquals(
        1, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultMaxAutoRetriesNextServer());
    ...
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult)
            .getDefaultEnableGzipContentEncodingFilter());
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultEnablePrimeConnections());
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultEnableRequestThrottling());
    assertFalse(((DefaultClientConfigImpl) actualNewConfigResult).getDefaultEnableZoneAffinity());
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultEnableZoneExclusivity());
    ...
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultOkToRetryOnAllOperations());
    assertFalse(
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultUseIpAddressForServer());
    assertTrue(
        ((DefaultClientConfigImpl) actualNewConfigResult)
    ...
    assertEquals(
        ...
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultMinPrimeConnectionsRatio(),
        0.0f);
    assertEquals(
    ...
    assertEquals(
        ...
        ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultPercentageNiwsEventLogged(),
        0.0f);
    assertEquals(

...
public class IClientConfigDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"java.lang.Object IClientConfig.getOrDefault(IClientConfigKey)"})
  ...
  public void testGetIfSet() {
    // Arrange
    IClientConfig buildResult = Builder.newBuilder().ignoreUserTokenInConnectionPoolForSecureClient(true).build();

    // Act and Assert
    assertFalse(buildResult.getIfSet((new DefaultClientConfigImplTest()).new NewConfigKey<>("Config Key")).isPresent());
  }

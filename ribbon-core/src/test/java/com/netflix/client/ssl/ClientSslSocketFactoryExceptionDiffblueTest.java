...
public class ClientSslSocketFactoryExceptionDiffblueTest {
  /**
   * Test {@link ClientSslSocketFactoryException#ClientSslSocketFactoryException(String,
   * Throwable)}.
   *
   * <p>Method under test: {@link
   * ClientSslSocketFactoryException#ClientSslSocketFactoryException(String, Throwable)}
   */
  @Test

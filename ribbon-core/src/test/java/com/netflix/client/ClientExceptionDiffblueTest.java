...
public class ClientExceptionDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link ErrorType#getName(int)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Then return LocalizedMessage is {@code , code=1->CONFIGURATION}.
   * </ul>
   *
   * <p>Method under test: {@link ClientException#ClientException(ErrorType)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewClientException_thenReturnLocalizedMessageIsCode1Configuration3() {
    // Arrange and Act
    ClientException actualClientException =
        new ClientException(ErrorType.CONFIGURATION, null, new Throwable());
   ...
   *
   * <ul>
   *   <li>Then return LocalizedMessage is {@code , code=23->UNKNOWN ERROR CODE}.
   * </ul>
   *
   * <p>Method under test: {@link ClientException#ClientException(int)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewClientException_whenAString_thenReturnErrorMessageIsAString4() {
    // Arrange and Act
    ClientException actualClientException =
        new ClientException(
   ...
   * <ul>
   *   <li>When {@code GENERAL}.
   *   <li>Then return InternalMessage is {@code {no message: 0}}.
   * </ul>
   *
   * <p>Method under test: {@link ClientException#ClientException(ErrorType)}
   */
  ...
  public void testNewClientException_whenGeneral_thenReturnInternalMessageIsNoMessage02() {
    // Arrange and Act
    ClientException actualClientException =
        new ClientException(ErrorType.GENERAL, null, new Throwable());
   ...
   *
   * <ul>
   *   <li>Then return {@code {no message: 1}}.
   * </ul>
   *
   * <p>Method under test: {@link ClientException#getInternalMessage()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link ClientException#getErrorCodes(Class)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue

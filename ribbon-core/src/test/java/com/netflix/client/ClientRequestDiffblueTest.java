...
public class ClientRequestDiffblueTest {
  ...
  @MethodsUnderTest({
    ...
    "void ClientRequest.<init>(URI)",
    "void ClientRequest.<init>(URI, Object, boolean)",
    "void ClientRequest.<init>(URI, Object, boolean, IClientConfig)",
    "Object ClientRequest.getLoadBalancerKey()",
    "IClientConfig ClientRequest.getOverrideConfig()",
    "URI ClientRequest.getUri()",
    "ClientRequest ClientRequest.setLoadBalancerKey(Object)",
    "ClientRequest ClientRequest.setOverrideConfig(IClientConfig)",
    "ClientRequest ClientRequest.setUri(URI)"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    ClientRequest actualClientRequest = new ClientRequest();
    ClientRequest actualSetLoadBalancerKeyResult =
        actualClientRequest.setLoadBalancerKey("Load Balancer Key");
    IClientConfig overrideConfig =
        Builder.newBuilder().ignoreUserTokenInConnectionPoolForSecureClient(true).build();
    ClientRequest actualSetOverrideConfigResult =
        actualClientRequest.setOverrideConfig(overrideConfig);
  ...
  public void testGettersAndSetters2() {
    ...
    // Act
    ClientRequest actualClientRequest =
        new ClientRequest(uri, "Load Balancer Key", true, overrideConfig);
    ClientRequest actualSetLoadBalancerKeyResult =
        actualClientRequest.setLoadBalancerKey("Load Balancer Key");
    IClientConfig overrideConfig2 =
        Builder.newBuilder().ignoreUserTokenInConnectionPoolForSecureClient(true).build();
    ClientRequest actualSetOverrideConfigResult =
        actualClientRequest.setOverrideConfig(overrideConfig2);
  ...
  public void testGettersAndSetters_whenPropertyIsJavaIoTmpdirIsTestTxtToUri() {
    // Arrange and Act
    ClientRequest actualClientRequest =
        new ClientRequest(Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toUri());
    ClientRequest actualSetLoadBalancerKeyResult =
        actualClientRequest.setLoadBalancerKey("Load Balancer Key");
    IClientConfig overrideConfig =
        Builder.newBuilder().ignoreUserTokenInConnectionPoolForSecureClient(true).build();

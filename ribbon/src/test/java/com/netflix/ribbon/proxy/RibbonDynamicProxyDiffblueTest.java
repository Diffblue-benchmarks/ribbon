...
public class RibbonDynamicProxyDiffblueTest {
  ...
  /**
   * Test {@link RibbonDynamicProxy#newInstance(Class, HttpResourceGroup)} with {@code clientInterface}, {@code httpResourceGroup}.
   * <p>
   * Method under test: {@link RibbonDynamicProxy#newInstance(Class, HttpResourceGroup)}
   */
  @Test

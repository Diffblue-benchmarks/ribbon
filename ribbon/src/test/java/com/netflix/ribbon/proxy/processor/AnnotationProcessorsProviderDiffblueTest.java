...
public class AnnotationProcessorsProviderDiffblueTest {
  /**
   * Test DefaultAnnotationProcessorsProvider {@link
   * DefaultAnnotationProcessorsProvider#DefaultAnnotationProcessorsProvider()}.
   *
   ...
   *
   * <p>Method under test: {@link AnnotationProcessorsProvider#register(AnnotationProcessor)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testRegister() {
    // Arrange
    DefaultAnnotationProcessorsProvider defaultAnnotationProcessorsProvider =
        new DefaultAnnotationProcessorsProvider();
   ...
   *
   * <p>Method under test: {@link AnnotationProcessorsProvider#getProcessors()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue

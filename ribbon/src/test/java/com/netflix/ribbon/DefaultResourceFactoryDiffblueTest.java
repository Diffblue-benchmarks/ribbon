...
public class DefaultResourceFactoryDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DefaultResourceFactory#DefaultResourceFactory(ClientConfigFactory,
   * RibbonTransportFactory, AnnotationProcessorsProvider)}
   */
  @Test
  ...
  public void testNewDefaultResourceFactory() {
    ...
    DefaultResourceFactory actualDefaultResourceFactory =
        new DefaultResourceFactory(
            clientConfigFactory, transportFactory, AnnotationProcessorsProvider.DEFAULT);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DefaultResourceFactory.<init>(ClientConfigFactory, RibbonTransportFactory)"
  })

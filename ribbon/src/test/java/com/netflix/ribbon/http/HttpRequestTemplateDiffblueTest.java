...
public class HttpRequestTemplateDiffblueTest {
   ...
   *
   * <ul>
   *   <li>{@link CacheProviderWithKeyTemplate#CacheProviderWithKeyTemplate(ParsedTemplate,
   *       CacheProvider)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CacheProviderWithKeyTemplate.<init>(ParsedTemplate, CacheProvider)",
  ...
  public void testCacheProviderWithKeyTemplateGettersAndSetters() {
    ...
    // Act
    CacheProviderWithKeyTemplate<Object> actualCacheProviderWithKeyTemplate =
        new CacheProviderWithKeyTemplate<>(keyTemplate, provider);

...
public class RibbonResourceFactoryDiffblueTest {
   ...
   *
   * <p>Method under test: {@link RibbonResourceFactory#getClientConfigFactory()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testGetClientConfigFactory() {
    // Arrange and Act
    ClientConfigFactory actualClientConfigFactory =
        RibbonResourceFactory.DEFAULT.getClientConfigFactory();
    ...
    assertEquals(
        ...
        0.0f);
    assertEquals(
        200, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultMaxTotalConnections());
    assertEquals(
        200, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultMaxTotalHttpConnections());
    assertEquals(200, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultPoolMaxThreads());
    assertEquals(
        2000, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultConnectTimeout());
    assertEquals(
        2000,
    ...
    assertEquals(
        50, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultMaxConnectionsPerHost());
    assertEquals(
        50,
    ...
    assertEquals(
        900L, ((DefaultClientConfigImpl) actualNewConfigResult).getDefaultPoolKeepAliveTime());
    assertEquals(
        TimeUnit.SECONDS,

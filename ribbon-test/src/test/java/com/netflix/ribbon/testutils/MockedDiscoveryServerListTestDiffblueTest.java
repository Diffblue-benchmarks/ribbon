...
public class MockedDiscoveryServerListTestDiffblueTest {
  ...
  public void testGetDummyInstanceInfo() {
    ...
    List<InstanceInfo> actualDummyInstanceInfo =
        MockedDiscoveryServerListTest.getDummyInstanceInfo(
            "Passed in hostname is blank, not setting it", serverList);
   ...
   *   <li>Then return first HostName is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link MockedDiscoveryServerListTest#getDummyInstanceInfo(String, List)}
   */
  ...
  public void testGetDummyInstanceInfo_givenServerWithIdIs42_thenReturnFirstHostNameIs42() {
    ...
    // Act
    List<InstanceInfo> actualDummyInstanceInfo =
        MockedDiscoveryServerListTest.getDummyInstanceInfo("\"TestApplication\"", serverList);
    ...
    assertEquals("\"TESTAPPLICATION\"", getResult.getAppName());
  }
  ...
  public void testGetDummyInstanceInfo_givenServerWithIdIs42_thenReturnSizeIsTwo() {
    ...
    InstanceInfo expectedGetResult = actualDummyInstanceInfo.get(0);
    assertEquals(expectedGetResult, actualDummyInstanceInfo.get(1));
  }

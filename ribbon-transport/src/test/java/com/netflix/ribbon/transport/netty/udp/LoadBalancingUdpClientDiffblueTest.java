...
public class LoadBalancingUdpClientDiffblueTest {
  /**
   * Test {@link LoadBalancingUdpClient#LoadBalancingUdpClient(ILoadBalancer, IClientConfig,
   * RetryHandler, PipelineConfigurator)}.
   *
   * <p>Method under test: {@link LoadBalancingUdpClient#LoadBalancingUdpClient(ILoadBalancer,
   * IClientConfig, RetryHandler, PipelineConfigurator)}
   */
  @Test
  ...
  public void testNewLoadBalancingUdpClient() {
    ...
    // Act
    LoadBalancingUdpClient<Object, Object> actualLoadBalancingUdpClient =
   ...
   *
   * <ul>
   *   <li>Then return LoadBalancerContext ClientName is {@code default}.
   * </ul>
   *
   * <p>Method under test: {@link LoadBalancingUdpClient#LoadBalancingUdpClient(ILoadBalancer,
   * IClientConfig, RetryHandler, PipelineConfigurator)}
   ...
   *
   * <p>Method under test: {@link LoadBalancingUdpClient#createRxClient(Server)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateRxClient() {
    ...
    RxClient<Object, Object> actualCreateRxClientResult =
        loadBalancingUdpClient.createRxClient(new Server("42"));
   ...
   * </ul>
   *
   * <p>Method under test: {@link LoadBalancingUdpClient#createListener(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateListener_thenConnectionTimesReturnBasicTimer() {
    ...
    MetricEventsListener<? extends ClientMetricsEvent<?>> actualCreateListenerResult =
        loadBalancingUdpClient.createListener("Name");

    // Assert
    assertTrue(
        ((UdpClientListener) actualCreateListenerResult).getConnectionTimes()
            instanceof BasicTimer);
    assertTrue(
        ((UdpClientListener) actualCreateListenerResult).getFlushTimes() instanceof BasicTimer);
    assertTrue(
        ((UdpClientListener) actualCreateListenerResult).getPoolAcquireTimes()
            instanceof BasicTimer);
    assertTrue(
        ((UdpClientListener) actualCreateListenerResult).getPoolReleaseTimes()
            instanceof BasicTimer);
    assertTrue(
        ((UdpClientListener) actualCreateListenerResult).getWriteTimes() instanceof BasicTimer);

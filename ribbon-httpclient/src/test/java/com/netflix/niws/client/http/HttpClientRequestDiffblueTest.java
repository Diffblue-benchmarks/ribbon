...
public class HttpClientRequestDiffblueTest {
  ...
  public void testBuilderNewBuilder() {
    ...
    HttpClientRequest httpClientRequest = new Builder().build();
    assertNull(httpClientRequest.getOverrideConfig());
    assertNull(httpClientRequest.getLoadBalancerKey());
    assertNull(httpClientRequest.getEntity());
    assertNull(httpClientRequest.getUri());
    assertNull(httpClientRequest.getHeaders());
    assertNull(httpClientRequest.getQueryParams());
    assertEquals(Verb.GET, httpClientRequest.getVerb());
    assertTrue(httpClientRequest.isRetriable());
  }

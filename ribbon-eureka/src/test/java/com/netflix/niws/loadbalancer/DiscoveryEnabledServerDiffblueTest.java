...
public class DiscoveryEnabledServerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return Host is {@code 42 Main St}.
   * </ul>
   *
   * <p>Method under test: {@link DiscoveryEnabledServer#DiscoveryEnabledServer(InstanceInfo,
   * boolean, boolean)}
   */
  @Test
  ...
  public void testNewDiscoveryEnabledServer_thenReturnHostIs42MainSt() {
    ...
    // Act
    DiscoveryEnabledServer actualDiscoveryEnabledServer =
        new DiscoveryEnabledServer(instanceInfo, true, true);
  ...
  public void testNewDiscoveryEnabledServer_whenFalse() {
    ...
    // Act
    DiscoveryEnabledServer actualDiscoveryEnabledServer =
        new DiscoveryEnabledServer(instanceInfo, false);
  ...
  public void testNewDiscoveryEnabledServer_whenFalse_thenReturnHostIs42MainSt() {
    ...
    // Act
    DiscoveryEnabledServer actualDiscoveryEnabledServer =
        new DiscoveryEnabledServer(instanceInfo, false, true);
   ...
   * <ul>
   *   <li>When {@code false}.
   *   <li>Then return Host is {@code Host Name}.
   * </ul>
   *
   * <p>Method under test: {@link DiscoveryEnabledServer#DiscoveryEnabledServer(InstanceInfo,
   * boolean, boolean)}
  ...
  public void testNewDiscoveryEnabledServer_whenFalse_thenReturnHostIsHostName() {
    ...
    // Act
    DiscoveryEnabledServer actualDiscoveryEnabledServer =
        new DiscoveryEnabledServer(instanceInfo, true, false);
   ...
   *
   * <ul>
   *   <li>When {@link InstanceInfo.PortWrapper#PortWrapper(boolean, int)} with enabled is {@code
   *       false} and port is {@code 8080}.
   * </ul>
   *
   * <p>Method under test: {@link DiscoveryEnabledServer#DiscoveryEnabledServer(InstanceInfo,
   * boolean)}
  ...
  public void testNewDiscoveryEnabledServer_whenPortWrapperWithEnabledIsFalseAndPortIs8080() {
    ...
    // Act
    DiscoveryEnabledServer actualDiscoveryEnabledServer =
        new DiscoveryEnabledServer(instanceInfo, true);

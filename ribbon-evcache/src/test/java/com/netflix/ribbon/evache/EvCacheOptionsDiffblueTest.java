...
public class EvCacheOptionsDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link EvCacheOptions#EvCacheOptions(String, String, boolean, int, EVCacheTranscoder, String)}
  ...
  @MethodsUnderTest({"void EvCacheOptions.<init>(String, String, boolean, int, EVCacheTranscoder, String)",
      "String EvCacheOptions.getAppName()", "String EvCacheOptions.getCacheKeyTemplate()",
      "String EvCacheOptions.getCacheName()", "int EvCacheOptions.getTimeToLive()",
      "EVCacheTranscoder EvCacheOptions.getTranscoder()", "boolean EvCacheOptions.isEnableZoneFallback()"})
